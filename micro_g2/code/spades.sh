#!/bin/bash
# Modified by Ying-Xian for single-end SPAdes assembly
# 09-20-24
...
# Load the environment for SPAdes
...
spades_path="/projects/intro2gds/I2GDS2024/micro_g2/software/SPAdes-4.0.0-Linux/bin/spades.py"  # Updated path to spades.py
